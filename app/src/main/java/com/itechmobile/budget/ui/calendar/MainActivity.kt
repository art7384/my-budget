...
/*
        ...
        val models = TransactionService.INSTANCE.getNoDone(Date())
        if (!models.isEmpty()) {
...
/*
    ...
    private fun addMany(isPl: Boolean) {
        val intent = if(isPl) Intent(this, GreenTransactionActivity::class.java) else Intent(this, YellowTransactionActivity::class.java)
